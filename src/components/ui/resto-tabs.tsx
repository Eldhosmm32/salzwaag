  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=card]/tabs-list:data-[card=true]:min-w-50 group-data-[variant=card]/tabs-list:data-[card=true]:w-50 group-data-[variant=card]/tabs-list:data-[card=true]:h-40 group-data-[variant=card]/tabs-list:data-[card=true]:flex-none group-data-[variant=card]/tabs-list:data-[card=true]:p-0 group-data-[variant=card]/tabs-list:data-[card=true]:rounded-sm group-data-[variant=card]/tabs-list:data-[card=true]:overflow-hidden group-data-[variant=card]/tabs-list:data-[card=true]:border-0 group-data-[variant=card]/tabs-list:data-[card=true]:after:opacity-0",
        className
      )}
      {...props}
    >

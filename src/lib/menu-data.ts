/**
 * Shared menu data and types for all restaurant pages, menu page, and reservation.
 */
...
export const OPENING_HOURS_SIMPLE: Record<number, string[]> = {
...
export const menuDataBadi: MenuData = [
  {
...
export const menuDataRestaurantStafa: MenuData = [
  {
    section: 'Vorspeisen',
    items: [
...
export const menuDataBistroSchiffsteg: MenuData = [
  {
    section: 'Güggeli',
...
export const menuDataByRestaurant: Record<number, MenuData> = {
